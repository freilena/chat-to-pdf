 ...
 * Login Page
 * 
 * Provides OAuth authentication options for users to sign in.
...
export default function LoginPage() {
  ...
  const handleAppleSignIn = async () => {
    try {
      ...
      if (result?.error) {
        if (result.error === 'OAuthCallback') {
          setError('OAuth setup required: Please configure real Apple OAuth credentials in your environment variables. Current credentials are placeholders for development.');
        } else {
